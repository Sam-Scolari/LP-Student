                    ...
                    Padding(
                        ...
                        child: Column(children: [
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,children: [
                            ...
                            SizedBox(height: 200, width: 165,child: Card(color: Colors.greenAccent,child: Center(child: Icon(OMIcons.dateRange, color: Colors.white, size: 50)),)),
                            SizedBox(height: 200, width: 165,child: Card(color: Colors.greenAccent,child: Center(child: Icon(OMIcons.classIcon, color: Colors.white, size: 50,)),))
                          ]))
